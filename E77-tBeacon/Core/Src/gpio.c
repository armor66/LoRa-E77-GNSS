...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED_R_Pin|LED_B_Pin|BUZZ_Pin|GPS_EN_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = LED_R_Pin|LED_B_Pin|BUZZ_Pin;
  ...
  GPIO_InitStruct.Pin = GPS_EN_Pin|SW_OUT_Pin;
